...
void OGLRenderer::UpdateShaderMatrices()	{
	...
	//if (currentCShader) {
	//	glUniformMatrix4fv(glGetUniformLocation(currentCShader->GetProgram(), "modelMatrix"), 1, false, modelMatrix.values);
	//	glUniformMatrix4fv(glGetUniformLocation(currentCShader->GetProgram(), "viewMatrix"), 1, false, viewMatrix.values);
	//	glUniformMatrix4fv(glGetUniformLocation(currentCShader->GetProgram(), "projMatrix"), 1, false, projMatrix.values);
	//	glUniformMatrix4fv(glGetUniformLocation(currentCShader->GetProgram(), "textureMatrix"), 1, false, textureMatrix.values);
	//	glUniformMatrix4fv(glGetUniformLocation(currentCShader->GetProgram(), "shadowMatrix"), 1, false, shadowMatrix.values);
	//}
}
...
void OGLRenderer::BindShader(ComputeShader* s) {
	currentCShader = s;
	s->Bind();
}
